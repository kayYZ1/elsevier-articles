...
url = f"{base_url}?apiKey={api_key}&query={query}&date=2016&count=100"
...
# art_txt_2013 = "articles_txt_2013.json"
# art_txt_2023 = "articles_txt_2023.json"

art_img_2013 = "articles_img_2013.json"
art_img_2023 = "articles_img_2023.json"

with open(f"files/{art_img_2013}", "w") as file:
