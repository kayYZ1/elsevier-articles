...
plt.title("Liczba znaków bez spacji - ScienceDirect 2013")
...
plt.title("Liczba znaków ze spacjami - ScienceDirect 2013")
plt.xlabel("Liczba artykułów")
plt.ylabel("Liczba znaków")
plt.show()
...
plt.title("Liczba wyrazów - ScienceDirect 2013")
plt.xlabel("Liczba artykułów")
...
plt.title("Liczba znaków bez spacji - ScienceDirect 2023")
plt.xlabel("Liczba artykułów")
plt.ylabel("Liczba znaków")
plt.show()
...
plt.title("Liczba znaków ze spacjami - ScienceDirect 2023")
plt.xlabel("Liczba artykułów")
plt.ylabel("Liczba znaków")
plt.show()
...
plt.title("Liczba wyrazów - ScienceDirect 2023")
plt.xlabel("Liczba artykułów")
plt.ylabel("Liczba wyrazów")
plt.show()
